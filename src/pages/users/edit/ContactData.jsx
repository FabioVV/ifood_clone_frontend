    ...
    <DefaultPage>
      <div className='container-user-info'>
        <ul className='ul-user'>
            ...
            <li style={{marginBottom:'2.5rem'}}>
              <div className='user-info-edit'>
                <strong>
                  ...
                  <span style={{color: '#717171'}}>Mantenha seus dados de contato atualizados. </span>
                </strong>
              </div>
            </li>

            <li className='data-user' onClick={() =>{navigate('/minha-conta/email-contato')}}>
              <div className='user-info-edit'>
                <strong className='user_list_data_title'>
                  Email
                </strong>
                <span className='user-info-data font-bold'>
                  {User?.email}
                </span>
            ...
            <li className='data-user' onClick={() =>{navigate('/minha-conta/celular-contato')}}>
              <div className='user-info-edit'>
                <strong className='user_list_data_title'>
                  Celular
                </strong>
